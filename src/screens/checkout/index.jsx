...
import { YStack, XStack, StyledConfirmDialog, StyledCard, StyledCycle, StyledBadgeIcon, StyledButton, StyledSeparator, StyledBadge, StyledHeader, StyledSafeAreaView, StyledSpinner, StyledOkDialog, StyledSpacer, StyledText } from 'fluent-styles';
...
const CheckOut = () => {
    ...
    const { getItemCount, getItems, getTotalPrice, shop, deleteItem } = useAppContext()
    const { data } = useQueryTaxByStatus(1)
